...
let form_overlay = document.querySelector('.popup-container');
let form_name_input = form_overlay.querySelector('.form__field_name')
let form_about_input = form_overlay.querySelector('.form__field_about')
let form_close_btn = form_overlay.querySelector('.form__close-btn');
let form_submit_btn = form_overlay.querySelector('.form__submit-btn')
...
form_submit_btn.addEventListener("click", function (event) {
  ...
  let name = form_overlay.querySelector('.form__field_name')
  let about = form_overlay.querySelector('.form__field_about')
  form_overlay.style.display = "none";
